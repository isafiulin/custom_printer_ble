    ...
    public func peripheral(_ peripheral: CBPeripheral, didDiscoverServices error: Error?) {
           ...
           if let services = peripheral.services {
               for service in services {
                   ...
                   // Verification service uuid of the printer zebra
                   let ZPRINTER_SERVICE_UUID =  CBUUID(string: "38EB4A80-C570-11E3-9507-0002A5D5C51B")
                   let WRITE_TO_ZPRINTER_CHARACTERISTIC_UUID =  CBUUID(string: "38EB4A82-C570-11E3-9507-0002A5D5C51B")
                   let READ_FROM_ZPRINTER_CHARACTERISTIC_UUID =  CBUUID(string: "38EB4A81-C570-11E3-9507-0002A5D5C51B")
                   let targetServiceUUID2 =  CBUUID(string: "49535343-FE7D-4AE5-8FA9-9FAFD205E455")
                   if service.uuid == ZPRINTER_SERVICE_UUID || service.uuid == WRITE_TO_ZPRINTER_CHARACTERISTIC_UUID {
